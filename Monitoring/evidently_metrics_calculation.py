...
@task(retries=2, retry_delay_seconds=5, name="Prepare DB connection")
def prep_db():
...
@task(retries=2, retry_delay_seconds=5, name="calculate metrics then push to DB")
def calculate_metrics_postgresql(curr, i):
	...
	# Quantiles = result['metrics'][3]['result']['current']['ColumnQuantileMetric']
